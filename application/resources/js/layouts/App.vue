  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/announces">Объявления</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/filters">Фильтры</a>
        </li>
        <li class="nav-item">
    ...
    <form class="d-flex mb-2 mt-2">
      ...
      <button class="btn btn-outline-success me-5 btn-sm" type="submit">Search</button>

        <button type="button" class="btn btn-outline-light md-2 me-2 btn-sm">Войти</button>
        <button type="button" class="btn btn-warning md-2 me-4 btn-sm">Регистрация</button>
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column" v-if="cats">
                            <li class="nav-item" v-for="{ id, name } in cats" v-bind:key=id>
                                <a class="nav-link" aria-current="page" :href="'/announces/'+id">
...
//                alert('cat_id = ' + cat_id);
                this.$router.push( { name:'announces', params: {cat_id: id} } );
            },
        }
//        watch: {
//            $route() {
